  ...
  return (
    <StickyNavbarShell>
      <nav
        ...
        className="grid h-16 w-full grid-cols-[1fr_auto] items-center px-[10%] md:grid-cols-[1fr_auto_1fr]"
      >
        <Link
        ...
        <div className="justify-self-end">
          <Button asChild className="h-11 rounded-md px-4 font-mono text-base shadow-none">
