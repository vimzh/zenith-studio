...
export function HomeHero({ heading, subheading }: HomeHeroProps) {
  return (
    <section className="grid bg-muted/40 lg:grid-cols-[minmax(0,1.15fr)_minmax(24rem,0.85fr)]">
      <div className="flex min-h-[31rem] items-center px-5 py-12 sm:px-8 lg:min-h-[34rem] lg:px-12 xl:px-14">
